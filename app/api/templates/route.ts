...
export const GET = withErrorHandling(getHandler, "GET /api/templates", "getHandler");
...
export const POST = withErrorHandling(postHandler, "POST /api/templates", "postHandler");
