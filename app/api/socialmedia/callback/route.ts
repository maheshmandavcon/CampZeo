...
async function getHandler(request: NextRequest) {
    ...
    if (platform === "FACEBOOK" || platform === "INSTAGRAM") {
        const tokenUrl = `https://graph.facebook.com/v21.0/oauth/access_token?client_id=${clientIdConfig.value}&redirect_uri=${encodeURIComponent(redirectUri)}&client_secret=${clientSecretConfig.value}&code=${code}`;
...
export const GET = withErrorHandling(getHandler, "GET /api/socialmedia/callback", "getHandler");
