...
export const GET = withErrorHandling(getHandler, "GET /api/admin/platform-config");
...
export const POST = withErrorHandling(postHandler, "POST /api/admin/platform-config");
