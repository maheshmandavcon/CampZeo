...
// GET: List Organisations with Pagination, Search, Sorting
async function getOrganisationsHandler(req: Request) {
...
export const GET = withErrorHandling(getOrganisationsHandler, "GET /api/admin/organisations");

// POST: Create or Update Organisation
// POST: Create or Update Organisation
async function createUpdateOrganisationHandler(req: Request) {
    const user = await currentUser();
...
export const POST = withErrorHandling(createUpdateOrganisationHandler, "POST /api/admin/organisations");
