...
export const GET = withErrorHandling(getHandler, "GET /api/admin/billing-plans/:id");
export const PUT = withErrorHandling(putHandler, "PUT /api/admin/billing-plans/:id");
export const DELETE = withErrorHandling(deleteHandler, "DELETE /api/admin/billing-plans/:id");
