...
async function getFunnelHandler(request: NextRequest) {
    ...
    // Step 1: Get Campaign IDs for this org
...
export const GET = withErrorHandling(getFunnelHandler, 'GET /api/Analytics/funnel', 'getFunnelHandler');
